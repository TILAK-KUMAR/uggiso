class Strings {
  ...
  static const payment_secure_simple =
  ...
  static const enter_4_digit_code =
      'You need to enter the 4-digit code we send to your mobile number';
  ...
  static const your_uggiso_coins =
  ...
  static const List<String> hotel_distance_list = [
    'Street Hotel',
    'Food Truck',
    'Family Restaurant',
    'Bar and Restaurant'
  ...
  static const List<String> timing_period_list = [
    'Street Hotel',
    'Food Truck',
    'Family Restaurant',
    'Bar and Restaurant'
