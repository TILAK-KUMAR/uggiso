...
class _CreateOrderState extends State<CreateOrder> {
  ...
  void initState() {
    ...
    for(int i=0;i<widget.orderlist.length;i++){
      calculateTotalAmount(widget.orderlist[i]['price'], widget.orderlist[i]['quantity']);
                ...
                child: Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int count) {
                         item_total = item_total +(widget.orderlist[count]['price']) *
                             (widget.orderlist[count]['quantity']) ;
                         item_sub_total = item_total + gst_charges;

                        print('this is totla amount : $item_total');
                        print('this is sub totla amount : $item_sub_total');
                        return Padding(
